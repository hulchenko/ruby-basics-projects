...
def common_sports(current_sports, favorite_sports)
  current_sports.intersection(favorite_sports) # returns matching values. While Array.union will overwrite any duplicates in original array and return a combined array
end
